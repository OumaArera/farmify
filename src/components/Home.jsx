...
const Home = () => {
  ...
  const handleSearch = (query) => {
    ...
    if (query && filteredItems.length === 0) {
      setSearchMessage('No items found matching your search. Try browsing the categories in the sidebar.');
    } else {
      setSearchMessage('');
    }
  };
  ...
  return (
    <div className="bg-gray-50 min-h-screen">
      <div className="container mx-auto p-4 flex flex-col md:flex-row">
        ...
        <aside className="w-full md:w-1/4 mb-4 md:mb-0 md:pr-4 flex-none">
